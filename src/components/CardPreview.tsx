  ...
  return (
    <div className="relative group select-none">
      ...
      <div 
        ...
        className="relative w-full max-w-[178px] xs:max-w-[198px] sm:max-w-none sm:w-[280px] h-[245px] xs:h-[270px] sm:h-[390px] rounded-2xl sm:rounded-[32px] overflow-hidden bg-[#050505] border-2 shadow-2xl flex flex-col justify-between p-2.5 sm:p-4 transition-transform duration-500 hover:scale-[1.02] border-white/10"
        style={{ 
